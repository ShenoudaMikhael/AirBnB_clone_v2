...
class TestState(unittest.TestCase):
    ...
    def test_str(self):
        ...
        self.assertIn("'created_at': {} \
            ".format(repr(self.state.created_at)), s)
        self.assertIn("'updated_at': {} \
            ".format(repr(self.state.updated_at)), s)
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(
            self.state.created_at.isoformat(), state_dict["created_at"])
        self.assertEqual(
            self.state.updated_at.isoformat(), state_dict["updated_at"])
